<template>
	<div class='p-6 h-page max-w-big mx-auto'>
		...
		<div class='flex flex-wrap'>
			<div class='w-full md:w-7/12'>
				<div v-show="loading">
					<h2 class='text-4xl font-hairline tw-color'>Loading...</h2>
				</div>
				<div v-if="noData">
			...
			<div class='w-full md:w-5/12 p-0 md:p-4'>
				<div class='bg-green-100 rounded shadow-2xl p-6 sticky border border-green-400' style="top:30px;" v-if="lists.length">
					...
					<div class='my-4'>
						If you think you will use the tool a lot you can <a class='text-blue-500 cursor-pointer'>buy a subscription and download unlimted lists each month</a>.
					</div>
					<div class='my-4'>
