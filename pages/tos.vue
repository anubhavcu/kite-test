<template>
	<div class='p-10'>
	<div class='prose max-w-3xl mx-auto rounded bg-white p-4'>
		<h1>Website Terms and Conditions of Use</h1>

		<h2>1. Terms</h2>

		<p>By accessing this Website, accessible from https://KiteList.com, you are agreeing to be bound by these
		...
		<p>Permission is granted to temporarily download one copy of the materials on Kite List's Website for personal,
		...
		<ul>
			...
			<li>attempt to reverse engineer any software contained on Kite List's Website;</li>
			<li>remove any copyright or other proprietary notations from the materials; or</li>
			<li>transferring the materials to another person or "mirror" the materials on any other server.</li>
		</ul>

		<p>This will let Kite List to terminate upon violations of any of these restrictions. Upon termination, your
		...
		<p>All the materials on Kite List’s Website are provided "as is". Kite List makes no warranties, may it be
			expressed or implied, therefore negates all other warranties. Furthermore, Kite List does not make any
		...
		<p>Kite List or its suppliers will not be hold accountable for any damages that will arise with the use or
			inability to use the materials on Kite List’s Website, even if Kite List or an authorize representative of
		...
		<p>The materials appearing on Kite List’s Website may include technical, typographical, or photographic errors.
			Kite List will not promise that any of the materials in this Website are accurate, complete, or current.
			Kite List may change the materials contained on its Website at any time without notice. Kite List does not
			make any commitment to update the materials.</p>

		<h2>6. Links</h2>

		<p>Kite List has not reviewed all of the sites linked to its Website and is not responsible for the contents of
			any such linked site. The presence of any link does not imply endorsement by Kite List of the site. The use
			of any linked website is at the user’s own risk.</p>

		<h2>7. Site Terms of Use Modifications</h2>

		<p>Kite List may revise these Terms of Use for its Website at any time without prior notice. By using this
			Website, you are agreeing to be bound by the current version of these Terms and Conditions of Use.</p>

		<h2>8. Your Privacy</h2>

		<h1>Privacy Policy for Kite List</h1>

		<p>At https://KiteList.com, accessible from https://KiteList.com, one of our main priorities is the privacy of
			our visitors. This Privacy Policy document contains types of information that is collected and recorded by
			https://KiteList.com and how we use it.</p>
		...
		<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
			regards to the information that they shared and/or collect in https://KiteList.com. This policy is not
			applicable to any information collected offline or via channels other than this website. Our Privacy Policy
			was created with the help of the <a
				href="https://www.privacypolicyonline.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.
		</p>
		...
		<p>https://KiteList.com follows a standard procedure of using log files. These files log visitors when they
		...
		<p>Like any other website, https://KiteList.com uses 'cookies'. These cookies are used to store information
		...
		<p>For more general information on cookies, please read <a
				href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies" from Cookie Consent</a>.</p>
		...
		<P>You may consult this list to find the Privacy Policy for each of the advertising partners of
			https://KiteList.com.</p>

		<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
			used in their respective advertisements and links that appear on https://KiteList.com, which are sent
		...
		<p>Note that https://KiteList.com has no access to or control over these cookies that are used by third-party
			advertisers.</p>

		<h2>Third Party Privacy Policies</h2>

		<p>https://KiteList.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
		...
		<p>https://KiteList.com does not knowingly collect any Personal Identifiable Information from children under the
		...
		<p>Any claim related to Kite List's Website shall be governed by the laws of it without regards to its conflict
			of law provisions.</p>
	</div>		
	</div>
</template>
...
h2{
	@apply font-semibold text-xl mt-6 mb-1
}
ul{
